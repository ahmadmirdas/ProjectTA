      ...
      <table class="table table-hover">
       ...
       @foreach($data_tps as $tps)
        <tr>
          ...
          <td>{{$tps->namatps}}</td>
          <td>{{$tps->jumlahdpt}}</td>
          <td><a href="/admin/tps/{{$tps->id}}/edit-tps" class="btn btn-warning btn btn-sm">Edit</a></td>
          <td><a href="{{ route('show.pemilih', $tps->id) }}" class="btn btn-info btn btn-sm">Show</a></td>
      </tr>
      @endforeach
    </table>
  </div>
